...
Phaser.Physics.Arcade.Body.prototype = {
    ...
    */
    preUpdate: function () {
        ...
        this.position.x = (this.sprite.position.x - (this.sprite.anchor.x * this.width)) + this.offset.x;
        this.position.y = (this.sprite.position.y - (this.sprite.anchor.y * this.height)) + this.offset.y;
